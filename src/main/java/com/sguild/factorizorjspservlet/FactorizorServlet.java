 ...
 */
package com.sguild.factorizorjspservlet;
...
public class FactorizorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            //Set all the results as attributes on the request so they are
            //available to the result.jsp
            ...
            //Get the request dispatcher for result.jsp and forward
            //the request to result.jsp
            ...
            // Set numberToFactor as an attribute on the request
            // so that it is available to result.jsp
            request.setAttribute("numberToFactor", numberToFactor);
